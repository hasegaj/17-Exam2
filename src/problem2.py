...
###############################################################################
# DO: 2.  READ the   Point   class defined below.
...
class Triangle(object):
    ...
    def area(self):
        ...
        g = self.a.distance_from(self.b)
        h = self.b.distance_from(self.c)
        i = self.c.distance_from(self.a)
        perimeter = g + h + i
        s = perimeter/2
        area = math.sqrt(s*(s-g)*(s-h)*(s-i))
